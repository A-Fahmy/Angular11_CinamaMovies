...
import { EditRolesListModel } from '../models/EditRolesListModel';
...
export class AdminService {
  ...
  baseUrl = 'http://localhost:53476/api/Admin/';
  ...
  GetRolePermission(RoleId: string): Observable<EditRolesListModel[]> {
   // return this.http.get<EditRolesListModel[]>(this.baseUrl + 'GetRolePermission/' + RoleId, this.headers).pipe();
    return this.http.get<EditRolesListModel[]>(this.baseUrl + 'GetRolePermission_Procedures/' + RoleId, this.headers).pipe();
  }

  GetRow_RolePermission(RoleId: string,componentId: number): Observable<EditRolesListModel> {
    return this.http.get<EditRolesListModel>(this.baseUrl + 'GetRowRolePermission/' + RoleId+'/'+componentId, this.headers).pipe();
  }

  InsertRolePermission(LtsrolePermissio: EditRolesListModel[]): Observable<EditRolesListModel[]> {
    return this.http.post<EditRolesListModel[]>(this.baseUrl + 'InsertRolePermission', LtsrolePermissio, this.headers).pipe();
  }
